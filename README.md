...
> AI 都會寫程式碼了，還需要學程式設計嗎？這篇逐章導讀帶你重新看懂 YouTube 神作《Programming Thinking》：變數、條件、迴圈、函式、範疇、傳址、字典、遞迴⋯⋯十一個核心概念拆解成白話直覺，還原你以為早就懂了、其實從沒真正搞懂的心智模型。搭配十一張原創圖解與繁中字幕影片，兩小時硬核內容，濃縮成一篇看得完的深度導讀。
>
> （社群分享介紹文・170 字）
